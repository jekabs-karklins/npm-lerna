...
class EnDictionary {
    constructor() {
        ...
        this.map.put('NOT_ALLOWED_PROPOSAL_SUBMITTED', 'The operation is not allowed, because the proposal is already submitted');
        ...
        this.map.put('NOT_LOGGED_IN', 'Not logged in');
        this.map.put('NOT_REVIEWER_OF_PROPOSAL', 'You are not reviewer of the proposal');
        ...
        this.map.put('VALUE_CONSTRAINT_REJECTION', 'Value does not match constraints');
...
//# sourceMappingURL=EnDictionary.js.map